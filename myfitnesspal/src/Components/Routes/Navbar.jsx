        ...
        <>
            <div id="navbar-parent">
                <div id="navbar-header">
                    ...
                    <Link to="/home" id="img-myfitnesspal">  <h1>myfitnesspal <sup>TM</sup> </h1></Link>
                ...
                <div id="navigations">
                    <div id="navigation-details">
                        <button> <Link id="link-color" to="/home">MY HOME</Link> </button>
                        <button> <Link id="link-color" to="/food">FOOD</Link> </button>
                        <button> <Link id="link-color" to="/exercise">EXCERCISE</Link> </button>
                        <button> <Link id="link-color" to="/reports">REPORTS</Link> </button>
                        <button> <Link id="link-color" to="#">APPS</Link> </button>
                        <button> <Link id="link-color" to="#">COMMUNITY</Link> </button>
                        <button> <Link id="link-color" to="/blogpage">BLOG</Link> </button>
                        <button> <Link id="link-color" to="#">PREMIUM</Link> </button>
