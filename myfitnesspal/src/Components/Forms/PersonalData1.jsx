...
const GenderSelect = () => {
  ...
  return (
    <select id='g_select' value={selectedGender} onChange={handleChange} placeholder="Select Gender">
...
function PersonaData1() {
  return (
    <div>
      ...
      <div id='mainDivP'>
        <div id='goal_heading'>
        <h3 className='c'>Please select which sex we should use to calculate your calorie needs.</h3><br/>
        <GenderSelect/>
        </div><br/>
        <div>
    ...
    <div>
      ...
      <div id='mainDivP2'>
        ...
        <div>
          ...
          <p>Don't worry. This doesn't affect your daily calorie goal and you can always change it later.</p>
...
function Login() {
  ...
  return (
    <div>
      <div id='head'>
        <img onClick={<Landing/>} src="https://seekvectorlogo.com/wp-content/uploads/2022/02/myfitnesspal-vector-logo-2022.png" style={{height:"90px"}}/>
      </div>
      <div id='mainDivL'>
        <div id='cover'>
  ...
  return (
    <div>
      ...
      <div id='mainDivL'>
        ...
        <div>
        <Link id='explorebtn' to='/home'><button>EXPLORE MYFITNESSPAL</button></Link>
        </div>
      </div>
    </div>
  )
